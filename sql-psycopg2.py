...
# build a cursor object of the databse
...
# Query 7 - select all tracks where the composer is
# "Bruce Dickinson" from the "Track" table
# cursor.execute('SELECT * FROM "Track" WHERE "Composer" = %s',
#                ["Bruce Dickinson"])

# Query 8 - select all tracks where the composer is
# "test" from the "Track" table
